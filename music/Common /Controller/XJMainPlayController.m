...
- (void)updateUI{
    ...
    _mainPlayView.likeBtn.selected = [[XJPLayManager sharedInstance] hasFavouriteItem];
...
- (void)likeBtnClick:(UIButton *)sender{
    ...
    if(sender.selected){
        [[XJPLayManager sharedInstance] setFavouriteSong];
    }else{
        [[XJPLayManager sharedInstance] deleFavouriteOrHistorySong];
    }
